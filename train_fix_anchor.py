...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint,
             debug_from, logger, split_idx, pretrained_iter, add_dist):
    first_iter = 0
    ...
    scene = Scene(dataset, gaussians, load_iteration=pretrained_iter, shuffle=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrained_iter", type=int, default=30_000)
    ...
    training(lp.extract(args), op.extract(args), pp.extract(args), args.test_iterations, args.save_iterations,
             ...
             split_idx=args.split_idx, pretrained_iter = args.pretrained_iter, add_dist=args.add_dist)
