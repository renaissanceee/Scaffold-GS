...
output_dir = "/cluster/work/cvl/jiezcao/jiameng/Scaffold-GS/benchmark_stmt_nerf_up"
...
def train_scene(gpu, scene, factor):
    cmd = f"python train.py -s {dataset_dir}/{scene} -m {output_dir}/{scene} -r {factor} --eval --white_background --port {6110 + int(gpu)} " \
