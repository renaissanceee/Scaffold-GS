...
output_dir = "/cluster/work/cvl/jiezcao/jiameng/Scaffold-GS/nerf_ours_up"
...
def train_scene(gpu, scene, factor):
    get_folder = "/cluster/work/cvl/jiezcao/jiameng/Scaffold-GS/benchmark_stmt_nerf_up"
    ...
    for scale in [4, 2, 1]:
        ...
        cmd = f"python train_two_stage_syn.py -s {pseudo_gt} " \
              f"-m {model_path} -r 1 --white_background --port {2000 + int(gpu)} --load_gaussian {trained_gaussian} " \
